         ...
         <div class="top-bar">
            <div class="container">
               <div class="top-content">
                  ...
                  <div class="top-right">
                     <ul>
                        <li><a target="blank" href="{{$setting->facebook}}"><i class="fab fa-facebook-square"></i></a></li>
                        <li><a target="blank" href="{{$setting->twitter}}"><i class="fab fa-twitter-square"></i></a></li>
                        <li><a target="blank" href="{{$setting->youtube}}"><i class="fab fa-youtube-square"></i></a></li>
                        <li><a target="blank" href="{{$setting->email}}"><i class="fas fa-envelope-square"></i></a></li>
                     </ul>
                  </div>
                  <!-- top-right -->
               </div>
                  ...
                  <ul class="navbar-nav">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                           <li class="dropdown-item"><a class="nav-link"  href="#">ঢাকা বিভাগ</a></li>
                           <li class="dropdown-item" ><a class="nav-link" href="#">চট্টগ্রাম বিভাগ</a></li>
                           <li class="dropdown-item"><a  class="nav-link" href="#">সিলেট বিভাগ</a></li>
                           <li class="dropdown-item"><a class="nav-link"  href="#">বরিশাল  বিভাগ</a></li>
                           <li class="dropdown-item" ><a class="nav-link" href="#">খুলনা বিভাগ</a></li>
                           <li class="dropdown-item"><a  class="nav-link" href="#">রাজশাহী  বিভাগ</a></li>
                           <li class="dropdown-item"><a  class="nav-link" href="#">রংপুর  বিভাগ</a></li>
                           <li class="dropdown-item"><a  class="nav-link" href="#">ময়মনসিংহ   বিভাগ</a></li>
                        </ul>
                     </li>
                     <!-- dropdown -->
                  </ul>
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-6">
                     <div class="widget widget-one">
                        <div class="widget-logo">
                           <a href="#"><img style=" width: 400px;" src="{{asset($setting->site_logo)}}" class="img-fluid"></a>
                        </div>
                        <!-- widget-logo -->
                        <div class="widget-social">
                           <ul>
                              <li><a target="blank" href="{{$setting->facebook}}"><i class="fab fa-facebook"></i></a></li>
                              <li><a target="blank" href="{{$setting->twitter}}"><i class="fab fa-twitter"></i></a></li>
                              <li><a target="blank" href="{{$setting->youtube}}"><i class="fab fa-youtube"></i></a></li>
                              <li><a target="blank" href="{{$setting->email}}"><i class="fas fa-envelope-square"></i></a></li>
                           </ul>
                        </div>
                        <!-- widget-social -->
